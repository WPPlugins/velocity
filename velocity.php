   ...
   class velocity{	  
      ...
      public $counter = 0;
   	...
   	function __construct(){		      	
   		...
   		define('VELOCITY_VERSION', '1.0.1');
   		define('VELOCITY_RELEASE_DATE', 'May 9, 2016');
      ...
      */
   	...
   	*/
   	...
   	public function velocity_enqueue_scripts(){   		
   		//wp_enqueue_script( 'velocity', plugins_url( '/core/js/velocity.js', __FILE__ ), array('jquery'),  '1.0', true );  
   		wp_enqueue_script( 'velocity', plugins_url( '/core/js/velocity.min.js', __FILE__ ), array('jquery'),  '1.0', true );   		
   	}	
