=== Velocity - Video Lazy Loading ===
Contributors: dcooney
Donate link: https://connekthq.com/donate/
Tags: YouTube, Vimeo, SoundCloud, performance, lazy load, lazy loading, lazy load video, audio, speed, demand, on-demand, responsive, mobile, 
...
*   **type** - Choose a media type [youtube, vimeo, soundcloud].
